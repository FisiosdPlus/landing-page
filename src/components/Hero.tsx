...
export function Hero() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-white">
      ...
      <div className="absolute bottom-20 left-10 w-[400px] h-[400px] bg-gradient-to-br from-blue-50/50 to-purple-50/50 rounded-full blur-3xl" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 pt-32 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="animate-fade-in-up">
            {/* Professional Badge */}
            <div className="inline-flex items-center gap-3 bg-blue-50 px-5 py-3 rounded-full mb-8 border border-blue-100">
              <Award className="w-5 h-5 text-blue-600" />
              <span className="text-blue-900 text-sm">Quiropráctico Certificado - Más de 5 Años de Experiencia</span>
            </div>
            
            {/* Main Heading - Professional & Clear */}
            <h1 className="text-5xl sm:text-6xl lg:text-7xl text-gray-900 mb-6 leading-tight">
              Quiropraxia
              <span className="block text-blue-600 mt-2">y Fisioterapia</span>
            </h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
              <div className="flex items-center gap-3 animate-fade-in-up delay-100">
                ...
                <span className="text-gray-700">Quiropráctico Certificado</span>
              </div>
              ...
              <div className="flex items-center gap-3 animate-fade-in-up delay-200">
                ...
                <span className="text-gray-700">Atención 100% Personalizada</span>
              </div>
              ...
              <div className="flex items-center gap-3 animate-fade-in-up delay-300">
                ...
                <span className="text-gray-700">Tratamientos Individuales</span>
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-10 animate-fade-in-up delay-500">
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-gray-900 rounded-xl border-2 border-gray-200 hover:border-blue-600 hover:text-blue-600 transition-all duration-300 shadow-sm hover:shadow-md"
              >
            ...
            {/* Trust Indicators */}
            <div className="flex flex-wrap items-center gap-6 text-sm text-gray-500 animate-fade-in-up delay-600">
          ...
          <div className="relative hidden lg:block animate-fade-in delay-300">
            <div className="relative">
              ...
              {/* Floating Stats Card */}
              <div className="absolute bottom-8 left-8 right-8 bg-white/95 backdrop-blur-sm rounded-2xl p-6 shadow-2xl animate-slide-in-right delay-500">
                <div className="grid grid-cols-3 gap-6 text-center">
                  <div className="border-r border-gray-200 last:border-0">
                    <div className="text-3xl text-blue-600 mb-1">5+</div>
                    <div className="text-xs text-gray-600">Años de<br />Experiencia</div>
                  </div>
                  <div className="border-r border-gray-200 last:border-0">
                    <div className="text-3xl text-green-600 mb-1">100%</div>
                    <div className="text-xs text-gray-600">Atención<br />Personal</div>
                  </div>
                  <div>
                    <div className="text-3xl text-purple-600 mb-1">1:1</div>
                    <div className="text-xs text-gray-600">Trato<br />Individual</div>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute -top-6 -right-6 bg-white rounded-2xl p-4 shadow-xl border border-gray-100 animate-float">
                <div className="text-center">
                  ...
                  <div className="text-xs text-gray-900 mb-1">Certificado</div>
        ...
        <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8 animate-fade-in-up delay-700">
          <div className="text-center group hover:scale-105 transition-transform duration-300">
            ...
            <h3 className="text-gray-900 mb-1">Primera Consulta</h3>
          ...
          <div className="text-center group hover:scale-105 transition-transform duration-300">
            ...
            <h3 className="text-gray-900 mb-1">Horarios Flexibles</h3>
            <p className="text-sm text-gray-600">Adaptados a ti</p>
          </div>
          ...
          <div className="text-center group hover:scale-105 transition-transform duration-300">
            <div className="w-16 h-16 bg-orange-100 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:bg-orange-600 transition-colors">
              <Award className="w-8 h-8 text-orange-600 group-hover:text-white transition-colors" />
            </div>
            <h3 className="text-gray-900 mb-1">Resultados</h3>
            <p className="text-sm text-gray-600">Comprobados</p>
          </div>
        </div>
      </div>
    </section>
