      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map((stat, index) => (
            <div
              key={index}
              className="group relative bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 animate-fade-in-up hover-lift"
            ...
            >
              ...
              <div className="text-4xl text-gray-900 dark:text-white mb-3">{stat.number}</div>
              <div className="text-gray-600 dark:text-gray-400 leading-tight">{stat.label}</div>
